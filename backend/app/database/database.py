...
def load_db_environment_variables():
    load_dotenv()
    global POSTGRES_USER, POSTGRES_PASSWORD, POSTGRES_HOST, POSTGRES_DB
...
def create_db_connection(user, password, host, dbname="postgres"):
    try:
...
def init_engine_and_session(user, password, host, db_name):
...
conn = create_db_connection(POSTGRES_USER, POSTGRES_PASSWORD, POSTGRES_HOST)
